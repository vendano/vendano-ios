...
class FAQs {
    ...
    let onboarding: [FAQItem] = [
        ...
        .init(icon: "shield",
              ...
              tldr: "Your 24-word phrase secures everything.",
              answer: "Only your secret 24-word phrase can move your ADA. Keep it offline.",
              clarify: "Your ADA can only move with your secret 24-word recovery phrase. Make sure you keep a physical record of it somewhere safe. Vendano never stores private keys on its servers.",
              details: "Those 24 words are your private key. Lose them and no one - not even Vendano - can recover your funds; share them and anyone can empty your wallet. We store only encrypted public information on our servers; private keys never leave your device. Cardano’s proof-of-stake model removes mining hacks like \"51 % attacks,\" but your own key hygiene (writing the phrase on paper, not screenshots) is the single most important safety step."),
        .init(icon: "folder",
              ...
              details: "Imagine your wallet address as a PO Box number printed on every package (transaction) you send or receive. The box itself lives in the global Cardano network, not inside the app. Vendano helps you write new labels (transactions) and digitally sign them with your 24-word key; it never touches the contents of the box. Delete the app, reinstall on a new phone, enter your phrase, and the box - and all the ADA inside - re-appear."),
        .init(icon: "lock.doc",
    ...
    let additional: [FAQItem] = [
        ...
        .init(icon: "iphone.slash",
              ...
              tldr: "Re-install & enter your 24 words.",
              answer: "Funds live on the blockchain, not the device.",
              clarify: "Your 24-word phrase restores the wallet on any phone or computer that supports Cardano.",
        ...
        .init(icon: "building.columns",
              ...
              answer: "Your 24-word phrase is standard BIP-39.",
              clarify: "Import that phrase into Daedalus, Eternl, Nami, etc. and your ADA is right there.",
    ...
    /*
     .init(icon: "checkmark.shield",
           ...
           tldr: "Yes—delegate right in the app.",
           answer: "Stake ADA to a pool and earn ~3–4 % yearly.",
